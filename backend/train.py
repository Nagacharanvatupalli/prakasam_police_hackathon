...
def main():
    parser = argparse.ArgumentParser(description="Train YOLOv8 on a dataset YAML file.")
    parser.add_argument(
        "--data",
        default=None,
        help="Path to the YOLO dataset YAML file to use for training."
    )
    ...
    if not dataset_yaml.exists():
        ...
        print("Please provide --data <path/to/data.yaml> or create dataset.yaml in the backend folder.")
        sys.exit(1)
